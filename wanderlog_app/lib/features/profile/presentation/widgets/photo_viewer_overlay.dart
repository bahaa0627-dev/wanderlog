...
class _PhotoViewerOverlayState extends ConsumerState<PhotoViewerOverlay> {
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                // Spot name - clickable to view spot detail
                Expanded(
                  child: GestureDetector(
                    onTap: () => _openSpotDetail(photo),
                    child: Text(
                      photo.spotName,
                      style: const TextStyle(
                        fontFamily: 'ReemKufi',
            ...
            // Location - clickable to view spot detail
            GestureDetector(
              onTap: () => _openSpotDetail(photo),
              child: Row(
                children: [
  ...
  Future<void> _openSpotDetail(CheckInPhoto photo) async {
    ...
    try {
      // Fetch spot data by ID
      final spot = await ref.read(spotProvider(photo.spotId).future);
      ...
      showModalBottomSheet<void>(
        ...
        builder: (_) => UnifiedSpotDetailModal(
          spot: spot,
          initialIsVisited: true,
          initialVisitDate: photo.visitDate,
        ),
      );
    } catch (e) {
      // Close loading dialog
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text('Failed to load spot details: $e'),
