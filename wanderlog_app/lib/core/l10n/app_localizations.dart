...
class AppLocalizations {
  ...
  String get accountNotLoggedIn =>
      isEnglish ? "Let's vago into the world together" : '让我们一起 vago 探索世界';
  String get tapToLogin => isEnglish ? 'Tap to sign in' : '点击登录';
  String get logoutTitle => isEnglish ? 'Log out' : '退出登录';
  String get logoutConfirm =>
      isEnglish ? 'Are you sure you want to log out?' : '确定要退出登录吗？';
  ...
  String get recommendPlaceDescription =>
      isEnglish ? 'Help us build the database together' : '帮助我们共建数据库';
  ...
  String get uploadImageOptional =>
      isEnglish ? 'Upload Image (Optional)' : '上传图片（选填）';
  String get tapToUploadImage =>
      isEnglish ? 'Tap to upload a signature photo' : '点击上传标志性图片';
  String get submit => isEnglish ? 'Submit' : '提交';
  String get submitting => isEnglish ? 'Submitting...' : '提交中...';
  String get submitSuccess =>
      isEnglish ? 'Thanks for your recommendation!' : '感谢您的推荐！';
  String get submitFailed =>
      isEnglish ? 'Submit failed, please try again' : '提交失败，请重试';
  ...
  String get pleaseEnterPlaceName =>
      isEnglish ? 'Please enter place name' : '请输入地点名称';

  // Feedback
  String get feedbackTitle => isEnglish ? 'Feedback' : '反馈';
  String get feedbackDescription =>
      isEnglish ? 'Feel free to ask me anything' : '欢迎来问我任何事';
  ...
  String get permissionDenied =>
      isEnglish ? 'Please allow photo access in settings' : '请在设置中允许访问相册';

  // Toast messages - Collection
  String get collectionSaved => isEnglish ? 'Saved to collection' : '收藏成功';
  String get collectionRemoved =>
      isEnglish ? 'Removed from collection' : '取消收藏';
  String get operationFailed =>
      isEnglish ? 'Operation failed, please try again' : '操作失败，请重试';
  ...
  String get shareComingSoon =>
      isEnglish ? 'Share feature coming soon' : '分享功能即将上线';
  String get photoUploadComingSoon =>
      isEnglish ? 'Photo upload coming soon' : '照片上传功能即将上线';
