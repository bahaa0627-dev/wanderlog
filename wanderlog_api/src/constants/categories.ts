...
export const CATEGORIES: Record<string, CategoryDefinition> = {
  ...
  university: {
    ...
    googleKeywords: ['university', 'college', 'campus', 'school'],
    osmTags: ['amenity=university', 'amenity=college'],
    wikidataP31: ['university', 'college', 'educational institution'],
    fsqKeywords: ['University', 'College', 'Campus'],
    defaultTags: [],
  },
  temple: {
    slug: 'temple',
    en: 'Temple',
    zh: '寺庙',
    googleTypes: ['hindu_temple', 'buddhist_temple', 'place_of_worship'],
    googleKeywords: ['temple', 'shrine', 'buddhist temple', 'hindu temple', 'shinto shrine'],
    osmTags: ['amenity=place_of_worship+religion=buddhist', 'amenity=place_of_worship+religion=shinto', 'amenity=place_of_worship+religion=hindu'],
    wikidataP31: ['temple', 'Buddhist temple', 'Hindu temple', 'Shinto shrine'],
    fsqKeywords: ['Temple', 'Shrine', 'Buddhist Temple'],
    defaultTags: [],
  },
  zoo: {
    slug: 'zoo',
    en: 'Zoo',
    zh: '动物园',
    googleTypes: ['zoo', 'aquarium'],
    googleKeywords: ['zoo', 'aquarium', 'wildlife park', 'animal park'],
    osmTags: ['tourism=zoo', 'tourism=aquarium'],
    wikidataP31: ['zoo', 'aquarium'],
...
export const CATEGORY_MIGRATION_MAP: Record<string, MigrationMapping> = {
  ...
  'church': { slug: 'church' },
  'Church': { slug: 'church' },
  'cathedral': { slug: 'church' },
  'Cathedral': { slug: 'church' },
  'basilica': { slug: 'church' },
  'Basilica': { slug: 'church' },
  'chapel': { slug: 'church' },
  'Chapel': { slug: 'church' },
  ...
  'point_of_interest': { slug: 'landmark' },
  'place_of_interest': { slug: 'landmark' },
  'monument': { slug: 'landmark' },
  'Monument': { slug: 'landmark' },
  'Historical Landmark': { slug: 'landmark' },
  'Natural landmark': { slug: 'landmark' },
  'Agricultural site': { slug: 'landmark' },
  // 新增分类
  'temple': { slug: 'temple' },
  'Temple': { slug: 'temple' },
  'shrine': { slug: 'temple' },
  'Shrine': { slug: 'temple' },
  'ShintoShrine': { slug: 'temple' },
  'university': { slug: 'university' },
  'University': { slug: 'university' },
  'college': { slug: 'university' },
  'College': { slug: 'university' },
  'zoo': { slug: 'zoo' },
  'Zoo': { slug: 'zoo' },
  'aquarium': { slug: 'zoo' },
  ...
  'night_club': { slug: 'bar' },
  'Night_club': { slug: 'bar' },
  'burger_shop': { slug: 'restaurant' },
  'Burger_shop': { slug: 'restaurant' },
  'establishment': { slug: 'landmark' },
  'Establishment': { slug: 'landmark' },
  'Waterfront promenade': { slug: 'landmark' },
  'bridge': { slug: 'landmark' },
  'Bridge': { slug: 'landmark' },
  'square': { slug: 'landmark' },
  'Square': { slug: 'landmark' },
  'town square': { slug: 'landmark' },
  'Town square': { slug: 'landmark' },
  'plaza': { slug: 'landmark' },
  'Plaza': { slug: 'landmark' },
  'cultural center': { slug: 'museum' },
  'Cultural center': { slug: 'museum' },
  'Cultural Center': { slug: 'museum' },
  'culture center': { slug: 'museum' },
  'arts center': { slug: 'museum' },
  'Arts center': { slug: 'museum' },
